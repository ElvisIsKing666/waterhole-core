...
.index-nav-full-width .nav-link {
    ...
    font-weight: 500;
    width: 75%;
    margin-left: 12.5%; /* This creates the 3/4 width with left indentation */
...
.index-nav-full-width .nav-link:hover {
    ...
    transform: translateX(4px); /* Slide right on hover to show it's under a header */
...
@media (max-width: 768px) {
    .index-nav-full-width .nav-link {
        width: 90%;
        margin-left: 5%; /* Adjust indentation for mobile */
    }
