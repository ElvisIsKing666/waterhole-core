...
trait HasImageAttributes
{
    ...
    private function uploadImage(
        ...
        Storage::disk(config('waterhole.uploads.disk'))->put($directory . '/' . $this->$attribute, $encodedImage);
    ...
    {
        if ($this->$attribute) {
            Storage::disk(config('waterhole.uploads.disk'))->delete($directory . '/' . $this->$attribute);
